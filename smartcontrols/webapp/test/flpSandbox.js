		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapui5mdsmartcontrols-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5mdsmartcontrols-display": {
								"semanticObject": "sapui5mdsmartcontrols",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui5.md.smartcontrols",
									"url": sap.ui.require.toUrl("sap/ui5/md/smartcontrols")
								}
							}
						}
					}
